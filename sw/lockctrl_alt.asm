...
; lockctrl_alt.asm
; Alternative Nanocontroller Program for Electronic Doorlock
...
trig:                                 ; 27 *** GPC triggers that it can be deactivated
  ...
  LD    ADR_GPCSTATE                  ; MEMPTR is now 1010, OPB overwritten
...
rtcloop:                              ; 40 *** RTC tick => update clock
  ...
  LD    ADR_SECS                      ; MEMPTR is now 1000, OPB overwritten
  ...
  CSTL
  CST   ADR_GPCSTATE
  LD    ADR_MINS                      ; MEMPTR is now 0111, OPB overwritten
  ADDI  1, 1>>3                       ; OPB    is now 0000.001
  STL
  CMPI  60, 60>>3                     ; OPB    is now 0111.100
  BNE   idle, idle
  CSTL
  LD    ADR_HOURS                     ; MEMPTR is now 0110, OPB overwritten
  ADDI  1, 1>>3                       ; OPB    is now 0000.001
  STL
